...
def main():
	...
	print("multithreading duration:", duration)


	# multiprocessing
	start = time.time()
	t1 = multiprocessing.Process(target=print_cube, args=(3,), name='t1')
	t2 = multiprocessing.Process(target=print_square, args=(4,), name='t2')
